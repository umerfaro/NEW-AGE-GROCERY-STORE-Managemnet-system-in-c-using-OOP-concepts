...
{  //update password
	...
	if (strcmp(n.c_str(), getPassword()) == 0) {
		Manager d;
		fstream obj("islamabadmanager.dat", ios::in | ios::out | ios::binary);
...
void Manager1::managernamechnage() {
	//update username
	Manager temp, manager;
	bool usernamecheck = true;
	fstream obj("islamabadmanager.dat", ios::binary | ios::in | ios::out);
	string n;

	cout << "Please enter updated username: ";
	cin >> n;
	ifstream fin("islamabadmanager.dat", ios::binary);
	if (!fin) {
		usernamecheck = true;
	}
	else
...
bool Manager1::login2()
{
	cout << "ISlamabad manager" << endl;

	Manager1 temp, manager;       //login ovverride use because polymorphism is being used
	string input;
	cout << "Enter username: ";
	cin >> input;
	...
	bool check = true;
	ifstream fileinput("islamabadmanager.dat", ios::binary);
	if (!fileinput) {
...
{  //menu override used to because polymorphism is used
	...
	system("CLS");
	cout << "ISlamabad manager" << endl << endl;
	if (login2() == 1)
	{
	lable5:
		...
		case 5:
		{
			inventorys.Write_THE_PRoduct(1);
			system("pause");
			goto lable5;
			break;
		}
		...
		case 7:
		{
			inventorys.refillquantityofproduct(1);
			system("pause");
			goto lable5;
			break;
		}
		case 8:
		{
			inventorys.modify_given_product_in_inventory(1);
			system("pause");
			goto lable5;
			break;
		}
		...
		case 10:
		{
			...
			cout << "\t\t\t\t\tPress 2 for karachi store" << endl;
			cin >> x;
			switch (x)
			{
			case 1:
			{
				...
				cin >> s;
				inventorys.search_seperate_product(s, 2);
				system("pause");
				goto lable5;
				break;
			...
			case 2:
			{
				...
				cout << "Enter product name to search" << endl;
				cin >> s;
				inventorys.search_seperate_product(s, 3);
				system("pause");
				goto lable5;
				break;
...
void Manager1::Register()
{
	...
	ifstream fileinput2("islamabadmanager.dat", ios::binary);
	if (!fileinput2) {
		usernamecheck = true;
	}
	else
	...
	ofstream myfile("islamabadmanager.dat", ios::binary | ios::app);
